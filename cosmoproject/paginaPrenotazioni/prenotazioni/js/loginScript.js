...
function prezzoTotale(){
	...
	if(spaPar=="Luna" && spaArr=="Saturno" && nav=="Comfort" || spaArr=="Luna" && spaPar=="Saturno" && nav=="Comfort"){
		document.myForm.prezzo.value=numBig*p_3*coo;return;
	}
